  ...
  <div class="overflow-hidden">
    <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 py-20">
      <div class="relative mx-auto max-w-4xl grid space-y-5 sm:space-y-10">
          ...
          <div class="flex-shrink-0 pb-5 sm:flex sm:pb-0 sm:pr-5">
            ...
            <div class="flex justify-center -space-x-3">
              ...
              <img
                ...
                alt="Image Description"
              >
              <span class="inline-flex items-center justify-center h-8 w-8 rounded-full ring-2 ring-white bg-gray-800">
        ...
        <form>
          <div class="mx-auto max-w-2xl sm:flex sm:space-x-3 p-3 bg-white border rounded-lg shadow-lg shadow-gray-100">
            <div class="pb-2 sm:pb-0 sm:flex-[1_0_0%]">
              ...
              ><span class="sr-only">Nome</span></label>
              <input
                id="hs-hero-name-1"
                type="text"
            ...
            <div class="pt-2 sm:pt-0 sm:pl-3 border-t border-gray-200 sm:border-t-0 sm:border-l sm:flex-[1_0_0%]">
              <label
                for="id_video"
                class="block text-sm font-medium"
              ><span class="sr-only">Video URL</span></label>
              <input
                v-model="url_video"
                type="text"
                class="py-3 px-4 block w-full border-transparent rounded-md text-sm focus:border-blue-500 focus:ring-blue-500 sm:p-4"
            ...
            <div class="pt-2 sm:pt-0 grid sm:block sm:flex-[0_0_auto]">
              <button
                class="py-3 px-4 inline-flex justify-center items-center gap-2 rounded-md border border-transparent font-semibold bg-blue-500 text-white hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all text-sm sm:p-4"
        ...
        <div class="pt-5 sm:pt-0 sm:pl-5 text-center">
          <div class="text-lg font-semibold text-gray-800">
            Procure um video no youtube, copie o link e insira. 
          </div>
          <div class="text-sm text-gray-500">
            Somente use links do youtube.
          </div>
        </div>
      </div>
    </div>
...
export default {
  ...
  setup() {
    ...
    const createRoom = () => {
      ...
      if(!url_video.value.includes('v=')) { 
        alert('Parece que essa url não é permitida.'); 
        return;
      }
